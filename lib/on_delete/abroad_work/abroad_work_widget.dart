...
import 'abroad_work_model.dart';
export 'abroad_work_model.dart';

class AbroadWorkWidget extends StatefulWidget {
  const AbroadWorkWidget({Key? key}) : super(key: key);

  @override
  _AbroadWorkWidgetState createState() => _AbroadWorkWidgetState();
}

class _AbroadWorkWidgetState extends State<AbroadWorkWidget> {
  late AbroadWorkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AbroadWorkModel());
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'sbbm8w70' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
