...
import 'online_study_n_model.dart';
export 'online_study_n_model.dart';

class OnlineStudyNWidget extends StatefulWidget {
  const OnlineStudyNWidget({Key? key}) : super(key: key);

  @override
  _OnlineStudyNWidgetState createState() => _OnlineStudyNWidgetState();
}

class _OnlineStudyNWidgetState extends State<OnlineStudyNWidget> {
  late OnlineStudyNModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnlineStudyNModel());
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'khxclcui' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                            ...
                                            child: FlutterFlowChoiceChips(
                                              options: [
                                                ...
                                                ChipData(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '67uj1j1f' /* История Казахстана */,
                                                )),
                                                ChipData(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'q9gyv0wm' /* Всемирная история */,
                                                ))
                                              ],
                                  ...
                                  children: [
                                                    ...
                                                    options: [
                                                      ...
                                                      ChipData(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        '3h43436y' /* История Казахстана */,
                                                      )),
                                                      ChipData(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'yo31n3yy' /* Всемирная история */,
                                                      ))
                                                    ],
                                                    onChanged: (val) =>
                                                        setState(() => _model
                                    ...
                                    Container(
                                      ...
                                      child: StreamBuilder<
                                          List<OnlineStudyRecord>>(
                                        stream: queryOnlineStudyRecord(
                                          queryBuilder: (onlineStudyRecord) =>
                                              onlineStudyRecord.where(
                                            'subjects',
                                            arrayContains:
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: Text(
                                                                      functions.listToString(columnOnlineStudyRecord
                                                                          .subjects
                                                                          .toList()),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
