...
import 'aboar_study_n_model.dart';
export 'aboar_study_n_model.dart';

class AboarStudyNWidget extends StatefulWidget {
  const AboarStudyNWidget({Key? key}) : super(key: key);

  @override
  _AboarStudyNWidgetState createState() => _AboarStudyNWidgetState();
}

class _AboarStudyNWidgetState extends State<AboarStudyNWidget> {
  late AboarStudyNModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboarStudyNModel());
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'vyiddzq5' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            columnStudyAbroadRecord.country,
                                                                            style:
