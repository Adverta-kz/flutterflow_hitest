...
import 'promotions_n_widget.dart' show PromotionsNWidget;
...
class PromotionsNModel extends FlutterFlowModel<PromotionsNWidget> {
  ...
  List<PromotionsRecord> simpleSearchResults = [];
