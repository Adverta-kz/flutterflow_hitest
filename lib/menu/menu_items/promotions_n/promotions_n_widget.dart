...
import 'promotions_n_model.dart';
export 'promotions_n_model.dart';

class PromotionsNWidget extends StatefulWidget {
  const PromotionsNWidget({Key? key}) : super(key: key);

  @override
  _PromotionsNWidgetState createState() => _PromotionsNWidgetState();
}

class _PromotionsNWidgetState extends State<PromotionsNWidget> {
  late PromotionsNModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PromotionsNModel());
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ut0ojxsr' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                ...
                                                                                decoration: BoxDecoration(),
                                                                                child: Text(
                                                                                  listViewPromotionsRecord.name.maybeHandleOverflow(
                                                                                    maxChars: 30,
                                                                                    replacement: '…',
                                                                                  ),
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                ...
                                                                                decoration: BoxDecoration(),
                                                                                child: Text(
                                                                                  resItem.name.maybeHandleOverflow(
                                                                                    maxChars: 30,
                                                                                    replacement: '…',
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Text(
                                                                                    columnPromotionsRecord.endDate,
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium,
                                                                                  ),
                                                                                ),
                                                                              ),
