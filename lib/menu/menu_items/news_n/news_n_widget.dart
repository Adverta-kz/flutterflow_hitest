...
import 'news_n_model.dart';
export 'news_n_model.dart';

class NewsNWidget extends StatefulWidget {
  const NewsNWidget({Key? key}) : super(key: key);

  @override
  _NewsNWidgetState createState() => _NewsNWidgetState();
}

class _NewsNWidgetState extends State<NewsNWidget> {
  late NewsNModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewsNModel());
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'mdu5k3pl' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
