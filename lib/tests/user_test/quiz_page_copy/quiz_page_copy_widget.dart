...
class QuizPageCopyWidget extends StatefulWidget {
  const QuizPageCopyWidget({Key? key}) : super(key: key);

  @override
  _QuizPageCopyWidgetState createState() => _QuizPageCopyWidgetState();
}
                                          ...
                                          child: FlutterFlowChoiceChips(
                                            options: [
                                              ...
                                              ChipData(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '07pk8mv2' /* История Казахстана */,
                                              )),
                                              ChipData(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'rqei9026' /* Всемирна история */,
                                              ))
                                            ],
                                            onChanged: (val) => setState(() =>
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'dw58e4mr' /* Здесь пока что ничего нет */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
