...
import 'admin_courses_model.dart';
export 'admin_courses_model.dart';
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '9w0ub567' /* Страница добавления/редактиров... */,
                                  ),
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'cvroxbv4' /* Введите название уч. заведения */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '23fj9i8s' /* Введите название курса */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                ...
                                                Container(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      validator: _model
                                                          .phoneNumberController7Validator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                                    ...
                                                    options: [
                                                      ...
                                                      ChipData(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'zpqgokht' /* История Казахстана */,
                                                      )),
                                                      ChipData(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'x5pxvwms' /* Всемирна история */,
                                                      ))
                                                    ],
                                                    onChanged: (val) =>
                                                        setState(() => _model
                                  ...
                                  if (widget.courseRef != null) {
                                    ...
                                    await widget.courseRef!.reference.update({
                                      ...createCoursesRecordData(
                                        ...
                                        why: _model.phoneNumberController7.text,
                                      ),
                                      ...mapToFirestore(
                                        {
                                    ...
                                    await CoursesRecord.collection.doc().set({
                                      ...createCoursesRecordData(
                                        businessName:
                                            _model.phoneNumberController1.text,
                                        title:
