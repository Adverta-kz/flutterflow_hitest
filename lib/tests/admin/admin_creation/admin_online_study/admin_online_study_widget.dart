...
import 'admin_online_study_model.dart';
export 'admin_online_study_model.dart';

class AdminOnlineStudyWidget extends StatefulWidget {
  const AdminOnlineStudyWidget({
    Key? key,
    this.onlineStudyRef,
  }) : super(key: key);

  final OnlineStudyRecord? onlineStudyRef;

  @override
  _AdminOnlineStudyWidgetState createState() => _AdminOnlineStudyWidgetState();
}

class _AdminOnlineStudyWidgetState extends State<AdminOnlineStudyWidget> {
  late AdminOnlineStudyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminOnlineStudyModel());
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'z81bgudm' /* Страница добавления/редактиров... */,
                                  ),
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'sgzhod9v' /* Введите методику обучения */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '2jrlmc74' /* Введите стоимость обучения */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '41568nwi' /* Введите контактный номер */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          '2ph35qxr' /* Введите учебное заведение */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                            ...
                                            child: FlutterFlowChoiceChips(
                                              options: [
                                                ...
                                                ChipData(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '4txh3nmt' /* История Казахстана */,
                                                )),
                                                ChipData(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'j35qe4e9' /* Всемирна история */,
                                                ))
                                              ],
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  if (widget.onlineStudyRef != null) {
                                    ...
                                    await widget.onlineStudyRef!.reference
                                        .update({
                                      ...createOnlineStudyRecordData(
                                        title:
                                    ...
                                    await OnlineStudyRecord.collection
                                        .doc()
                                        .set({
                                      ...createOnlineStudyRecordData(
                                        title:
