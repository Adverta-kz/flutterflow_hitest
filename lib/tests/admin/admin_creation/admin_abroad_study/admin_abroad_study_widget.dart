...
import 'admin_abroad_study_model.dart';
export 'admin_abroad_study_model.dart';

class AdminAbroadStudyWidget extends StatefulWidget {
  const AdminAbroadStudyWidget({
    Key? key,
    this.abroadStudyRef,
  }) : super(key: key);

  final StudyAbroadRecord? abroadStudyRef;

  @override
  _AdminAbroadStudyWidgetState createState() => _AdminAbroadStudyWidgetState();
}

class _AdminAbroadStudyWidgetState extends State<AdminAbroadStudyWidget> {
  late AdminAbroadStudyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminAbroadStudyModel());
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'vakoahgn' /* Страница добавления/редактиров... */,
                                  ),
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'ps98y0x1' /* Введите страну обучения */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'niafnf4u' /* Введите город обучения */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'peg5p089' /* Введите стоимость обучения */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'pcl38pez' /* Введите название учебного заве... */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                ...
                                                Container(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'enn6v7dm' /* Введите контактный номер */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      validator: _model
                                                          .phoneNumberController6Validator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  if (widget.abroadStudyRef != null) {
                                    ...
                                    await widget.abroadStudyRef!.reference
                                        .update(createStudyAbroadRecordData(
                                      name: _model.phoneNumberController1.text,
                                      ...
                                      contact:
                                          _model.phoneNumberController6.text,
                                    ));
                                    ...
                                    await StudyAbroadRecord.collection
                                        .doc()
                                        .set(createStudyAbroadRecordData(
                                          name: _model
                                          ...
                                          city: _model
                                              .phoneNumberController3.text,
                                          price: double.tryParse(_model
                                              .phoneNumberController4.text),
                                          educationalInstitution: _model
                                              .phoneNumberController5.text,
                                          author: currentUserReference,
                                          photo: _model.uploadedFileUrl,
                                          contact: _model
                                              .phoneNumberController6.text,
                                        ));
