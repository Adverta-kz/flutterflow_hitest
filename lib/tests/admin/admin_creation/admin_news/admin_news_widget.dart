...
import 'admin_news_model.dart';
export 'admin_news_model.dart';

class AdminNewsWidget extends StatefulWidget {
  const AdminNewsWidget({
    Key? key,
    this.newsRef,
  }) : super(key: key);
...
class _AdminNewsWidgetState extends State<AdminNewsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminNewsModel());
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '5hvn2tix' /* Страница добавления/редактиров... */,
                                  ),
                                                      ...
                                                      decoration:
                                                        ...
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          'lbrdu9zw' /* Введите заголовок новости */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
