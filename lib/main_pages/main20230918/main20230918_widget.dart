...
import 'main20230918_model.dart';
export 'main20230918_model.dart';

class Main20230918Widget extends StatefulWidget {
  const Main20230918Widget({Key? key}) : super(key: key);

  @override
  _Main20230918WidgetState createState() => _Main20230918WidgetState();
}

class _Main20230918WidgetState extends State<Main20230918Widget> {
  late Main20230918Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Main20230918Model());
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'vnsjsj6q' /* Выдаем электронные сертификаты... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '4pgxsz9n' /* Не упустите шанс выиграть путе... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'ommomy8x' /* Проходи олимпиады и турниры лу... */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyLarge
