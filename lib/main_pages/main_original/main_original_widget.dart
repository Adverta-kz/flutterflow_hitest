...
import 'main_original_model.dart';
export 'main_original_model.dart';

class MainOriginalWidget extends StatefulWidget {
  const MainOriginalWidget({Key? key}) : super(key: key);

  @override
  _MainOriginalWidgetState createState() => _MainOriginalWidgetState();
}

class _MainOriginalWidgetState extends State<MainOriginalWidget> {
  late MainOriginalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainOriginalModel());
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'du4nb50f' /* Выдаем электронные сертификаты... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '7gjosc4z' /* Не упустите шанс выиграть путе... */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'tc8xq30i' /* Проходи олимпиады и турниры лу... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
