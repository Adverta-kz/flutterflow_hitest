...
import 'tutors_detail_model.dart';
export 'tutors_detail_model.dart';

class TutorsDetailWidget extends StatefulWidget {
  const TutorsDetailWidget({
    Key? key,
  ...
  @override
  _TutorsDetailWidgetState createState() => _TutorsDetailWidgetState();
}

class _TutorsDetailWidgetState extends State<TutorsDetailWidget> {
  late TutorsDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TutorsDetailModel());
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '6967lsfe' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'wmpg3m8d' /* Стоимость одного занятия: */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
