...
class AbroadStudyDetailWidget extends StatefulWidget {
  const AbroadStudyDetailWidget({
    Key? key,
    required this.abroadDetail,
  }) : super(key: key);

  final StudyAbroadRecord? abroadDetail;
                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '7m7whn2b' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'ha8bizge' /* Стоимость одного занятия: */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
