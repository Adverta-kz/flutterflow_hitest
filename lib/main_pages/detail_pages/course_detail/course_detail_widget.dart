                                              ...
                                              child: InkWell(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'onq7b9gp' /* Зарегистрироваться/войти */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              valueOrDefault<String>(
                                                widget.coursesDoc?.businessName,
                                                'уч завед',
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
