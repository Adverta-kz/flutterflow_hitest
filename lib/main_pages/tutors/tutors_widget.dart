...
class _TutorsWidgetState extends State<TutorsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TutorsModel());
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      ...
                                      options: [
                                        ...
                                        FFLocalizations.of(context).getText(
                                          'pv51rimk' /* История Казахстана */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          '79xq2v4d' /* Всемирна история */,
                                        )
                                      ],
