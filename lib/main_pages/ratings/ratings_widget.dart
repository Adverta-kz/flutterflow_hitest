...
class _RatingsWidgetState extends State<RatingsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuizzesRecord>(
      stream: QuizzesRecord.getDocument(widget.quizRef!),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          'Общее количество очков: ${listViewQuizResultRecord.score.toString()}',
                                                                          maxLines:
                                                                              3,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          'Место в рейтинге: #${(listViewIndex + 1).toString()}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: 'Montserrat',
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  return GridView.builder(
                                                    ...
                                                    itemBuilder: (context,
                                                        gridViewIndex) {
                                                      final gridViewQuizResultRecord =
                                                          gridViewQuizResultRecordList[
                                                              gridViewIndex];
                                                                  ...
                                                                  Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          'Место в рейтинге: #${(gridViewIndex + 1).toString()}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: 'Montserrat',
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Общее количество очков: ${gridViewQuizResultRecord.score.toString()}',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium,
                                                                    ),
