...
class SearchResultsCopyWidget extends StatefulWidget {
  const SearchResultsCopyWidget({
    Key? key,
    this.fromHeader,
  }) : super(key: key);
  ...
  @override
  _SearchResultsCopyWidgetState createState() =>
      _SearchResultsCopyWidgetState();
}

class _SearchResultsCopyWidgetState extends State<SearchResultsCopyWidget> {
  late SearchResultsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchResultsCopyModel());
                          ...
                          content: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FutureBuilder<List<QuizzesRecord>>(
                                  future: QuizzesRecord.search(
                                ...
                                if (false)
                                  FutureBuilder<List<TournamentsRecord>>(
                                    future: TournamentsRecord.search(
                                      term: _model.textController1.text,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      return ListView.builder(
                                        ...
                                        shrinkWrap: true,
                                        scrollDirection: Axis.vertical,
                                        itemCount: listViewTournamentsRecordList
                                            .length,
                                        itemBuilder: (context, listViewIndex) {
                                ...
                                FutureBuilder<List<OnlineStudyRecord>>(
                                  future: OnlineStudyRecord.search(
                                    term: _model.textController1.text,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    ...
                                    return ListView.builder(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewOnlineStudyRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewOnlineStudyRecord =
                                            listViewOnlineStudyRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
                                ...
                                FutureBuilder<List<StudyAbroadRecord>>(
                                  future: StudyAbroadRecord.search(
                                    term: _model.textController1.text,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    ...
                                    return ListView.builder(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewStudyAbroadRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                ...
                                FutureBuilder<List<WorkAbroadRecord>>(
                                  future: WorkAbroadRecord.search(
                                    term: _model.textController1.text,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    ...
                                    return ListView.builder(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewWorkAbroadRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewWorkAbroadRecord =
                                            listViewWorkAbroadRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
                                ...
                                Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    FutureBuilder<List<PromotionsRecord>>(
                                      future: PromotionsRecord.search(
                                        term: _model.textController1.text,
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
