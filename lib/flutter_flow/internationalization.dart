...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // registerSchool
  {
    ...
    '1wc7ignh': {
      ...
      'kk': 'немесе Қонақ ретінде кіріңіз',
    },
    'qfpozjsl': {
      'ru': 'Регистрация',
      'kk': 'Тіркеу',
  ...
  // EditProfile
  {
    ...
    'osqgyvtx': {
      ...
      'kk':
          'Мұнда профиль туралы ақпаратты өңдеуге, байланыс ақпаратына, фотосуреттерге және басқа жеке ақпаратқа өзгертулер енгізуге болады.',
    },
    'xqjxquln': {
      'ru': 'Пополнение баланса',
      'kk': 'Балансыңызды толтырыңыз',
    ...
    '7b8ijgfk': {
      ...
      'kk':
          'Бұл бетте олимпиадаларға қатысу және басқа да қызметтерді төлеу үшін профильдік балансты толтыруға болады.',
    },
    'a9491ha8': {
      'ru': 'Рейтинги',
      'kk': 'Рейтингтер',
    ...
    'eiv3r76t': {
      ...
      'kk':
          'Мұнда сіз барлық олимпиадаларға қатысу нәтижелері бойынша позицияңызды көрсететін жалпы рейтингті таба аласыз.',
    },
    'y1au9k42': {
      'ru': 'Мои олимпиады',
      'kk': 'Менің олимпиадаларым',
    ...
    'ld0d18z3': {
      ...
      'kk':
          'Бұл бетте сіз қатысқан олимпиадалар тізімін және олардың әрқайсысы бойынша рейтингтегі орыныңызды көресіз.',
    },
    'gt993exz': {
      'ru': 'Новостная лента',
      'kk': 'Жаңалықтар тізімі',
    ...
    'k6mf0hxv': {
      ...
      'kk':
          'Мұнда сіз олимпиадаларға және профиліңізге қатысты соңғы жаңалықтар мен оқиғалар туралы хабардар боласыз.',
    },
    '6h21jf3t': {
      'ru': 'Профиль',
      'kk': 'Профиль',
  ...
  // Balance
  {
    ...
    'tw17iwzb': {
      ...
      'kk': 'Немесе өріске мән енгізіңіз',
    },
    'yb63v2w2': {
      'ru': '',
      'kk': '',
  ...
  // AdminNews
  {
    ...
    '5hvn2tix': {
      ...
      'kk': 'Жаңалықтарды қосу/өңдеуге арналған бет',
    },
    'lbrdu9zw': {
  ...
  // Contacts
  {
    ...
    'xok78o30': {
      'ru': 'Г. Алматы, Сатпаева 30/8, подъезд С, 2 этаж',
  ...
  // Politic
  {
    ...
    'fkxy4wtx': {
      'ru':
          '1.Общие положения\n\n1.1. Внимательно ознакомьтесь с текстом публичной оферты, и если Вы не согласны с каким-либо пунктом оферты, Вам предлагается отказаться от покупки Товаров или использования Услуг, предоставляемых Продавцом.\n1.2. В соответствии со статьей 395 Гражданского Кодекса Республики Казахстан (далее - ГК РК) данный документ является публичной офертой, и в случае принятия изложенных ниже условий физическое лицо, производящее акцепт этой оферты, осуществляет оплату Товара Продавца в соответствии с условиями настоящего Договора. В соответствии с пунктом 3 статьи 396 ГК РК, оплата Товара Покупателем является акцептом оферты, что считается равносильным заключению Договора на условиях, изложенных в оферте.\n1.3. В настоящей оферте, если контекст не требует иного, нижеприведенные термины имеют следующие значения:\n«Оферта» — публичное предложение Продавца, адресованное любому физическому/юридическому лицу, заключить с ним договор купли-продажи (далее — «Договор») на существующих условиях, содержащихся в Договоре, включая все его приложения. «Продавец» — компания, реализующая услугу прохождения олимпиад, предоставляемых ТОО “ЛЛС ТЕРРА ГРУП”, по сайту https://hitest.kz «Покупатель» — физическое или юридическое лицо, заключившее с Продавцом Договор на условиях, содержащихся в Договоре. «Акцепт» — полное и безоговорочное принятие Покупателем условий Договора. «Товар» — перечень олимпиад, предлагаемых для прохождения на интернет-сайте https://hitest.kz «Заказ» — отдельные позиции из списка олимпиад которые доступны после регистрации пользователя и указанные Покупателем на интернет-сайте https://hitest.kz Сайт – совокупность электронных документов (файлов) Продавца, доступных в сети Интернет по адресу https://hitest.kz\n\n2. Предмет договора\n\n2.1. Продавец предоставляет услугу в соответствии с действующим прейскурантом, опубликованным на интернет-сайте Продавца, а Покупатель производит оплату и принимает Товар в соответствии с условиями настоящего Договора.\n2.2. Настоящий Договор и все приложения к нему являются официальными документами Продавца и неотъемлемой частью Оферты.\n\n3. Размещение Заказа\n\n3.1. Заказ услуги осуществляется Покупателем на сайте https://hitest.kz\n3.2. При регистрации (размещении) Заказа на интернет-сайте Продавца, Покупатель обязуется предоставить регистрационную информацию о себе.\n3.3. Принятие Покупателем условий настоящего Договора осуществляется посредством внесения Покупателем соответствующих данных в регистрационную форму на интернет-сайте. Покупатель имеет право редактировать регистрационную информацию о себе. Продавец обязуется не сообщать регистрационные данные Покупателя, а также иную информацию, касающуюся личных данных Покупателя, лицам, не имеющим отношения к исполнению Заказа. Утвердив Заказ выбранного Товара, Покупатель предоставляет необходимую информацию для доставки товара.\n3.4. Покупатель несет ответственность за содержание и достоверность информации, предоставленной при размещении Заказа.\n\n4.Сроки исполнения Заказа\n\n4.1. Срок, в который Продавец обязуется исполнить Заказ, составляет не более 5 минут, возможность пройти олимпиаду появляется сразу после перевода денежных средств. Получение сертификата возможно после успешного прохождения олимпиады.\n4.2. Заказ считается исполненным в тот момент, когда у пользователя появляется возможность начать прохождение раннее оплаченной олимпиады.\n4.3. В случае предоставления Покупателем недостоверной информации о его контактных данных или составе Заказа, Продавец за ненадлежащее исполнение Заказа ответственности не несет.\n\n5. Оплата Заказа\n\n5.1. Оплата исполненного Заказа по выбору Покупателя может, осуществляется:\n1) путем перечисления денежных средств на расчетный счет Продавца;\n2) путем перечисления Покупателем денежных средств в режиме онлайн через систему электронных платежей следующими платежными средствами: -кредитные карты (VISA,EuroCard/MasterCard);\n- электронная наличность (WebMoney, Яндекс.Деньги, Qiwi и пр.).\n5.2. Цена на каждую позицию Товара отображается на сайте https://hitest.kz. В случае изменения цены на заказанные позиции продавец обязуется моментально поменять стоимость позиции на сайте.\n5.3. Цены на любые позиции Товара, указанные на интернет-сайте, могут быть изменены Продавцом в одностороннем порядке без уведомления Покупателя.\n5.4. Цена на любую позицию Товара отображает только стоимость Товара без учета установки, сборки и транспортных услуг.\n5.5. Оплата Покупателем самостоятельно размещенного Заказа на интернет-сайте означает согласие с Условиями настоящего Договора. День оплаты Заказа является датой заключения Договора оферты между Продавцом и Покупателем.\n\n6. Прочие условия\n\n6.1. Настоящим Покупатель соглашается с обязательными условиями настоящего Договора публичной оферты.\n6.2. В соответствии с условиями настоящего Договора публичной оферты Продавец имеет право отказать в размещении Заказа лицам, выражающим несогласие с условиями настоящего Договора.\n6.3. Продавец оставляет за собой право вносить изменения в настоящее Соглашение, в связи с чем Покупатель обязуется регулярно отслеживать изменения в Соглашении, опубликованном на сайте https://hitest.kz',
      'kk':
          'Бізге беретін жеке ақпарат \n\nБіз сайтта тіркелу, біз туралы немесе біздің қызметтеріміз туралы ақпаратты алуға қызығушылық танытқанда, мысалы, сайтта сынақтарды аяқтаған кезде немесе бізбен байланысқан кезде басқа жолмен.\n\nБіз жинайтын жеке ақпарат бізбен өзара әрекеттесуіңіздің контекстіне және сіз пайдаланатын қызметтер мен сайт мүмкіндіктеріне байланысты. Біз жинайтын жеке ақпарат мыналарды қамтуы мүмкін:\n\nСіз берген жеке ақпарат. Біз электрондық пошта мекенжайларын, пайдаланушы атын, құпия сөздерді, төлем мекенжайларын, дебеттік/кредиттік карта нөмірлерін, атауларды және басқа ұқсас ақпаратты жинаймыз.\n\nТөлем туралы ақпарат. Төлем жасасаңыз, төлем әдісі (несие картасының нөмірі сияқты) және төлем әдісімен байланысты қауіпсіздік коды сияқты төлеміңізді өңдеуге қажетті ақпаратты жинауымыз мүмкін. Барлық төлем ақпараты https://freedompay.money/kz сайтында сақталады\n\nСіз бізге берген барлық жеке ақпарат шынайы, толық және нақты болуы керек және осындай жеке ақпаратқа енгізілген кез келген өзгерістер туралы бізге хабарлауыңыз қажет.',
    },
    'ktmj6me6': {
  ...
  {
    '2ff1uv3x': {
      'ru': 'Платежи. Оплата банковской картой онлайн',
      'kk': 'Пайдаланушы келісімі, құпиялылық саясаты, ашық ұсыныс',
    },
    'pmkz1drt': {
      'ru':
    ...
    '615kz23c': {
      'ru': 'Безопасность онлайн-платежей',
      'kk': 'БІЗ ҚАНДАЙ АҚПАРАТ ЖИНАЙМЫЗ?',
    },
    '4bgx081n': {
      'ru':
    ...
    'l5wegchx': {
      'ru':
          'Бенефициар : ТОО \"ЛЛС ТЕРРА ГРУП\"\n\nИИН/БИН : ﻿230740038356\n\nНомер счета: ﻿KZ298562203133607544',
      'kk':
          'Бізге беретін жеке ақпарат \n\nБіз сайтта тіркелу, біз туралы немесе біздің қызметтеріміз туралы ақпаратты алуға қызығушылық танытқанда, мысалы, сайтта сынақтарды аяқтаған кезде немесе бізбен байланысқан кезде басқа жолмен.\n\nБіз жинайтын жеке ақпарат бізбен өзара әрекеттесуіңіздің контекстіне және сіз пайдаланатын қызметтер мен сайт мүмкіндіктеріне байланысты. Біз жинайтын жеке ақпарат мыналарды қамтуы мүмкін:\n\nСіз берген жеке ақпарат. Біз электрондық пошта мекенжайларын, пайдаланушы атын, құпия сөздерді, төлем мекенжайларын, дебеттік/кредиттік карта нөмірлерін, атауларды және басқа ұқсас ақпаратты жинаймыз.\n\nТөлем туралы ақпарат. Төлем жасасаңыз, төлем әдісі (несие картасының нөмірі сияқты) және төлем әдісімен байланысты қауіпсіздік коды сияқты төлеміңізді өңдеуге қажетті ақпаратты жинауымыз мүмкін. Барлық төлем ақпараты https://freedompay.money/kz сайтында сақталады\n\nСіз бізге берген барлық жеке ақпарат шынайы, толық және нақты болуы керек және осындай жеке ақпаратқа енгізілген кез келген өзгерістер туралы бізге хабарлауыңыз қажет.',
    },
    '3xbgl6qv': {
