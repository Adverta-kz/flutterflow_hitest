...
export 'register_school_model.dart';

class RegisterSchoolWidget extends StatefulWidget {
  const RegisterSchoolWidget({
    Key? key,
    String? role,
  })  : this.role = role ?? 'choosedrole',
        super(key: key);

  final String role;

  @override
  _RegisterSchoolWidgetState createState() => _RegisterSchoolWidgetState();
}

class _RegisterSchoolWidgetState extends State<RegisterSchoolWidget> {
  late RegisterSchoolModel _model;
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'uz6lj5xt' /* Мобильное приложение  интернет... */,
                                          ),
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '8e7yrdnk' /* Я согласен с условиями Оферты  */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                                                ...
                                                                suffixIcon:
                                                                  ...
                                                                  focusNode: FocusNode(
                                                                      skipTraversal:
                                                                          true),
                                                                  child: Icon(
                                                                    _model.passwordconfirmpcVisibility
                                                                        ? Icons
                                                                            .visibility_outlined
                                                                        : Icons
                                                                            .visibility_off_outlined,
